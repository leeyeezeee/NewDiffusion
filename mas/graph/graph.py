...
from mas.graph.node import Node
from mas.agents.agent_registry import AgentRegistry
from mas.prompt.prompt_set_registry import PromptSetRegistry
from mas.llm.profile_embedding import get_sentence_embedding
from mas.gnn.gcn import GCN,MLP
...
class Graph(ABC):
    ...
    def to_pyg_graph(self, input: Dict[str, Any]) -> Data:
        ...
        edge_attr = torch.ones(len(edge_indices))
